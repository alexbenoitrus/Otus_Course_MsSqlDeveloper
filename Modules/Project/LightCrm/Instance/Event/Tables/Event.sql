...
GO
CREATE NONCLUSTERED INDEX [IX_Event_Event_StartOn]
    ON [Event].[Event]([StartOn] ASC)
    INCLUDE([Name]);


GO
CREATE NONCLUSTERED INDEX [IX_Event_Event_Name]
    ON [Event].[Event]([Name] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Event_Event_EndOn]
    ON [Event].[Event]([EndOn] ASC)
    INCLUDE([Name]);


GO
CREATE NONCLUSTERED INDEX [FKIDX_Event_Event_PreviosEventId]
